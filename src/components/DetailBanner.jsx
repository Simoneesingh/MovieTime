import { Add, HorizontalRule, PlayArrow } from "@mui/icons-material";
        ...
        <div className="absolute -mt-24 text-white top-1/2 md:left-24 left-12">
          ...
          <div className="flex flex-col gap-4 mt-8">
            <div className="flex items-center gap-4">
              <button
                className="w-8 h-8 bg-b2 rounded-full md:w-12 md:h-12 drop-shadow-lg"
                onClick={handleClick}
              >
                <PlayArrow
